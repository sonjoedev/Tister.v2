...
setTimeout(function(){returnToDefault();
setTimeout(function(){
...
//moveablediv------------------------------------------------
const hdivelem =  document.getElementsByClassName("container")[0]
var divismove = false
...
hdivelem.style.top = defaultTop
}

//loading-------------------------------------------
const loadingLdiv = document.querySelector(".the-loading")
function loadingL(){
console.log("noo")
setTimeout(function(){
